...
"""
Script for JEB Decompiler. (Save as 'Decrypt.py')
"""
...
decrypt_methods = [
        {'name': 'Lcom/xx/xx/xx/xx/c;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;',
         'enc_args': [0, 1]
         }
]
...
class Decrypt(IScript):

    # ctx: IClientContext or IGraphicalClientContext
    def run(self, ctx):
        print('\n\nstart found')
        self.file = open('enc_str_list.txt', 'wt')
